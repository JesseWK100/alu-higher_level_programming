#!/usr/bin/python3
"""
This module contains a function to read and print the content of a UTF-8 encoded text file.
The function reads a specified file and outputs its content directly to stdout.

Functions:
    read_file(filename=""): Reads a UTF-8 encoded text file and prints its content to stdout.
"""
